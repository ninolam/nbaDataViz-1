    ...
    if (PlayerInfos !== undefined) {
      return (
        ...
        <div className="container">
          ...
          <section style = {{  backgroundColor: "#E2813A",backgroundImage: "url("+PlayerInfosMore.logo+")",backgroundPosition: "center",backgroundRepeat: "no-repeat"}} className="all-content">
