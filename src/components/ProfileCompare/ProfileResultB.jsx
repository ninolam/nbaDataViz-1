    ...
    if (PlayerInfos !== undefined) {
      return (
        ...
        <div className="container">
          ...
          <section style={{ backgroundColor: "#2D3142", backgroundImage: "url(" + PlayerInfosMore.logo + ")", backgroundPosition: "center", backgroundRepeat: "no-repeat" }} className={this.props.writing ? "all-content filter" : "all-content"}>
